...
Position const worgenRuntSpawnPos[] =
{
...
Position const worgenRuntRallyPos = { -1677.581299f, 1454.170410f, 52.2871f, 0.0f };

Position const crowleyStonewardHomePos = { -1679.73f, 1442.12f, 52.3705f, 0.750492f };
Position const tobiasMistmantleHomePos = { -1678.51f, 1438.79f, 52.3704f, 6.25315f };
