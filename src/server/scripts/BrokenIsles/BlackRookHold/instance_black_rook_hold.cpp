...
{
    { GOB_DOOR_AMALGAME_ENTER_1,        DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_ENTER_2,        DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_ROOM_1,         DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_ROOM_2,         DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_ROOM_3,         DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_ROOM_4,         DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_AMALGAME_EXIT,           DATA_AMALGAM_OF_SOULS,      DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_ILLYSANNA_PORTCULLIS_1,  DATA_ILLYSANNA_RAVENCREST,  DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_ILLYSANNA_PORTCULLIS_2,  DATA_ILLYSANNA_RAVENCREST,  DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_ILLYSANNA_ENTER,         DATA_ILLYSANNA_RAVENCREST,  DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_ILLYSANNA_EXIT_1,        DATA_ILLYSANNA_RAVENCREST,  DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_ILLYSANNA_EXIT_2,        DATA_ILLYSANNA_RAVENCREST,  DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_SMASHSPITE_ROOM,         DATA_SMASHSPITE,            DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GOB_DOOR_RAVENCREST_PASSAGE,      DATA_SMASHSPITE,            DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GOB_DOOR_RAVENCREST_ROOM,         DATA_LORD_RAVENCREST,       DOOR_TYPE_ROOM,    BOUNDARY_NONE },
};
