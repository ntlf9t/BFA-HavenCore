...
{
    { GO_DOOR_1,        DATA_GAROTHI_WORLDBREAKER,    DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_DOOR_2,        DATA_GAROTHI_WORLDBREAKER,    DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_DOOR_3,        DATA_GAROTHI_WORLDBREAKER,    DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_DOOR_4,        DATA_GAROTHI_WORLDBREAKER,    DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_BOSS6_1,       DATA_IMONAR_THE_SOULHUNTER,   DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_BOSS6_2,       DATA_IMONAR_THE_SOULHUNTER,   DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_BOSS7_1,       DATA_KINGAROTH,               DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_BOSS9_1,       DATA_NOURA_MOTHER_OF_FLAMES,  DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GO_BOSS9_2,       DATA_NOURA_MOTHER_OF_FLAMES,  DOOR_TYPE_PASSAGE, BOUNDARY_NONE },
    { GO_BOSS_VARIMATHRAS, DATA_VARIMATHRAS,          DOOR_TYPE_ROOM,    BOUNDARY_NONE },
    { GO_DOOR_PORTAL_KEEPER_HASABEL, DATA_PORTAL_KEEPER_HASABEL, DOOR_TYPE_ROOM, BOUNDARY_NONE },
    { GO_BOSS10,        DATA_AGGRAMAR,                DOOR_TYPE_ROOM,    BOUNDARY_NONE },
};
