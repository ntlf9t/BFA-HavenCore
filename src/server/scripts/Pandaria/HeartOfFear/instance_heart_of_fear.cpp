...
{
    {GOB_ANTECHAMBER_DOOR_ENTRANCE, 0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_ANTECHAMBER_DOOR_EXIT,     0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_ORATIUM_DOOR_ENTRANCE,     DATA_ZORLOK,    DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_QUARTERS_DOOR_ENTRANCE,    DATA_ZORLOK,    DOOR_TYPE_PASSAGE   , BOUNDARY_NONE },
    {GOB_QUARTERS_DOOR_EXIT,        DATA_TAYAK,     DOOR_TYPE_PASSAGE   , BOUNDARY_NONE },
    {GOB_STAIRWAYS_DOOR_EXIT,       0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_BALCONY_DOOR_EXIT,         DATA_MELJARAK,  DOOR_TYPE_PASSAGE   , BOUNDARY_NONE },
    {GOB_ATRIUM_DOOR_ENTRANCE,      0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_ATRIUM_DOOR_EXIT,          0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_SANCTUM_DOOR_ENTRANCE,     0,              DOOR_TYPE_ROOM      , BOUNDARY_NONE },
    {GOB_HEARTOFFEAR_DOOR_ENTRANCE, DATA_UNSOK,     DOOR_TYPE_PASSAGE   , BOUNDARY_NONE }
};
