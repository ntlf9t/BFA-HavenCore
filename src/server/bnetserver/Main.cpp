...
int main(int argc, char** argv)
{
    ...
    Trinity::Banner::Show("bnetserver",
            ...
            []()
        {
            ...
            TC_LOG_INFO("server.bnetserver", "Using SSL version: %s (library: %s)", OPENSSL_VERSION_TEXT, OpenSSL_version(TC_OPENSSL_VERSION_ARG));
    ...
    dbPingTimer->expires_after(Minutes(dbPingInterval));
    ...
    banExpiryCheckTimer->expires_after(Seconds(banExpiryCheckInterval));
    ...
    if (m_ServiceStatus != -1)
    {
        ...
        serviceStatusWatchTimer->expires_after(Seconds(1));
