...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_RECRUITER_CHARACTER,
    CHAR_INS_SHOP_ITEM,

    CHAR_SEL_ANTICHEAT_DAILY_REPORT,
    CHAR_SEL_ANTICHEAT_LOWEST_AVERAGES,
    CHAR_SEL_ANTICHEAT_MOST_REPORTS,
    CHAR_REP_ANTICHEAT_REPORT_STATUS,
    CHAR_REP_ANTICHEAT_DAILY_REPORT,
    CHAR_DEL_ANTICHEAT_REPORT_STATUS,
    CHAR_DEL_ANTICHEAT_REPORT_STATUS_ALL,
